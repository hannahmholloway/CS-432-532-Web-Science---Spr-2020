...
(mostMatching, leastMatching) = topMatches(prefs, '198')
print 'The 5 users that are most correlated to the substitute me:'
print str(mostMatching[0]) + '\n' + str(mostMatching[1]) + '\n' + str(mostMatching[2]) + '\n' + str(mostMatching[3]) + '\n' + str(mostMatching[4]) + '\n'

print 'The 5 users that are least correlated to the substitute me:'
